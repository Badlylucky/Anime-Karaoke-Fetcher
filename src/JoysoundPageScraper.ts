...
export async function fetchSongProperties(page: Readonly<Page>, itemPerPage: Readonly<number> = 20): Promise<{ title: string; reference: string | null }[]> {
  const songProperties: { title: string; reference: string | null }[] = [];
